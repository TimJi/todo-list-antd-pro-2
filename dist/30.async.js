      ...
      var y,
        ...
        (x = h.default.create({
          onValuesChange: function(e, t, a) {
            var l = e.dispatch;
            console.log(t, a), l({ type: 'list/fetch', payload: { count: 5 } });
          },
        })),
        y(
          (w =
            x(
              (w = (function(e) {
                function t() {
                  var e, a;
                  (0, s.default)(this, t);
                  for (var l = arguments.length, n = new Array(l), d = 0; d < l; d++)
                    n[d] = arguments[d];
                  return (
                    (a = (0, E.default)(
                      this,
                      (e = (0, g.default)(t)).call.apply(e, [this].concat(n))
                    )),
                    (a.setOwner = function() {
                      var e = a.props.form;
                                  ...
                                  M.default.createElement(
                                    ...
                                    l
                                      ? M.default.createElement(
                                          'span',
                                          null,
                                          M.default.createElement(m.default, { type: 'loading' }),
                                          ' \u52a0\u8f7d\u4e2d...'
                                        )
                                      : '\u52a0\u8f7d\u66f4\u591a'
                                  )
                                  ...
                                  M.default.createElement(
                                    ...
                                    M.default.createElement(
                                      ...
                                      M.default.createElement(
                                        'a',
                                        {
                                          className: C.default.selfTrigger,
                              ...
                              renderItem: function(e) {
                                return M.default.createElement(
                                  d.default.Item,
                                  {
                                    key: e.id,
                                    actions: [
                                      M.default.createElement(p, { type: 'star-o', text: e.star }),
                                      M.default.createElement(p, { type: 'like-o', text: e.like }),
                                      M.default.createElement(p, {
                                        type: 'message',
                                        text: e.message,
                                      }),
                                    ],
                                    extra: M.default.createElement('div', {
                                      className: C.default.listItemExtra,
                                    }),
                                  },
                                  M.default.createElement(d.default.Item.Meta, {
                                    title: M.default.createElement(
                                      'a',
                                      { className: C.default.listItemMetaTitle, href: e.href },
                                      e.title
                                    ),
                                    description: M.default.createElement(
                                      'span',
                                      null,
                                      M.default.createElement(u.default, null, 'Ant Design'),
                                      M.default.createElement(
                                        u.default,
                                        null,
                                        '\u8bbe\u8ba1\u8bed\u8a00'
                                  ...
                                  M.default.createElement(T.default, { data: e })
                                );
                              },
                            })
                          )
