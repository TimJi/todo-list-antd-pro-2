          ...
          (m = (function(e) {
            function t() {
              ...
              for (var n = arguments.length, l = new Array(n), r = 0; r < n; r++)
                l[r] = arguments[r];
              return (
                (a = (0, b.default)(this, (e = (0, y.default)(t)).call.apply(e, [this].concat(l)))),
                (a.state = { newTags: [], inputVisible: !1, inputValue: '' }),
                (a.onTabChange = function(e) {
                  var t = a.props.match;
                  switch (e) {
                    case 'articles':
                      j.default.push(''.concat(t.url, '/articles'));
                      break;
                    case 'applications':
                      j.default.push(''.concat(t.url, '/applications'));
                      break;
                    case 'projects':
                      j.default.push(''.concat(t.url, '/projects'));
                      break;
                    default:
                      break;
                  }
                ...
                (a.handleInputConfirm = function() {
                  var e = (0, T.default)((0, T.default)(a)),
                    t = e.state,
                    n = t.inputValue,
                    l = t.newTags;
                  n &&
                    ...
                    (l = (0, h.default)(l).concat([{ key: 'new-'.concat(l.length), label: n }])),
                  ...
                  value: function() {
                    var e = this.state,
                      ...
                      T = [
                        {
                          key: 'articles',
                          tab: C.default.createElement(
                            'span',
                            null,
                            '\u6587\u7ae0 ',
                            C.default.createElement('span', { style: { fontSize: 14 } }, '(8)')
                          ),
                        },
                        {
                          key: 'applications',
                    ...
                    return C.default.createElement(
                      I.default,
                      { className: P.default.userCenter },
                      C.default.createElement(
                        ...
                        C.default.createElement(
                          ...
                          C.default.createElement(
                            r.default,
                            { bordered: !1, style: { marginBottom: 24 }, loading: h },
                            m && Object.keys(m).length
                              ? C.default.createElement(
                                  ...
                                  C.default.createElement(
                                    'div',
                                    { className: P.default.avatarHolder },
                                    C.default.createElement('img', { alt: '', src: m.avatar }),
                                    C.default.createElement(
                                      'div',
                                      { className: P.default.name },
                                      m.name
                                    ),
                                    C.default.createElement('div', null, m.signature)
                                  ),
                                  C.default.createElement(
                                    'div',
                                    { className: P.default.detail },
                                    C.default.createElement(
                                      'p',
                                      null,
                                      C.default.createElement('i', { className: P.default.title }),
                                      m.title
                                    ),
                                    C.default.createElement(
                                      'p',
                                      null,
                                      C.default.createElement('i', { className: P.default.group }),
                                      m.group
                                    ),
                                    C.default.createElement(
                                      'p',
                                      ...
                                      m.geographic.province.label,
                                      m.geographic.city.label
                                    )
                                  ),
                                  C.default.createElement(g.default, { dashed: !0 }),
                                  C.default.createElement(
                                    'div',
                                    { className: P.default.tags },
                                    C.default.createElement(
                                      'div',
                                      { className: P.default.tagsTitle },
                                      '\u6807\u7b7e'
                                    ),
                                    m.tags.concat(t).map(function(e) {
                                      return C.default.createElement(
                                        f.default,
                                        { key: e.key },
                                        e.label
                                    ...
                                    !a &&
                                      C.default.createElement(
                                        ...
                                        C.default.createElement(i.default, { type: 'plus' })
                                      )
                                  ),
                                  ...
                                  C.default.createElement(
                                    'div',
                                    { className: P.default.team },
                                    C.default.createElement(
                                      'div',
                                      { className: P.default.teamTitle },
                                      '\u56e2\u961f'
                                    ),
                                    C.default.createElement(
                                      c.default,
