        ...
        o(
          (d = (function(e) {
            function t(e) {
              var n;
              (0, s.default)(this, t),
                (n = (0, r.default)(this, (0, l.default)(t).call(this, e))),
                (n.getmenu = function() {
                  var e = n.state.menuMap;
                  return Object.keys(e).map(function(t) {
                    return m.default.createElement(y, { key: t }, e[t]);
                  });
                }),
                ...
                (n.selectKey = function(e) {
                  var t = e.key;
                  g.default.push('/account/settings/'.concat(t)), n.setState({ selectKey: t });
                }),
                (n.resize = function() {
                  n.main &&
              ...
              var a = e.match,
                ...
                u = {
                  ...
                  security: m.default.createElement(h.FormattedMessage, {
                    id: 'app.settings.menuMap.security',
                    defaultMessage: 'Security Settings',
                  }),
                  binding: m.default.createElement(h.FormattedMessage, {
                    id: 'app.settings.menuMap.binding',
                    defaultMessage: 'Account Binding',
                  }),
                  notification: m.default.createElement(h.FormattedMessage, {
                    id: 'app.settings.menuMap.notification',
                    defaultMessage: 'New Message Notification',
                  }),
                },
                c = i.pathname.replace(''.concat(a.path, '/'), '');
              return (n.state = { mode: 'inline', menuMap: u, selectKey: u[c] ? c : 'base' }), n;
            }
            return (
              (0, c.default)(t, e),
              (0, u.default)(
                      ...
                      return m.default.createElement(
                        ...
                        m.default.createElement(
                          ...
                          m.default.createElement(
                            ...
                            m.default.createElement(
                              f.default,
                              { mode: s, selectedKeys: [u], onClick: this.selectKey },
                              this.getmenu()
                            )
                          ),
                          m.default.createElement(
